...
<body>
	...
	try {
		...
		if(!password.equals(confirmPassword)) {
			out.print("The passwords do not match. <a href='addCustomer.jsp'><button type='button'>Back</button></a>");
			return;
		}
		...
		if(result.next()) {
			out.print("User already exists. <a href='addCustomer.jsp'><button type='button'>Back</button></a>");
		}
		else {
