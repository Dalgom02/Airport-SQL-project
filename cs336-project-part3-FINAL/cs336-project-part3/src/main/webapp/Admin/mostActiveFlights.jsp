    ...
    <body>
        ...
        %>
                ...
                try {
                    ...
                    String query = "SELECT FlightNumber, COUNT(*) AS TicketCount FROM Tickets GROUP BY FlightNumber ORDER BY TicketCount DESC";
                ...
                <%
                            ...
                            do {
                                ...
                                int ticketCount = result.getInt("TicketCount");
                %>
                                <tr>
                                    <td><%= flightNumber %></td>
                                    <td><%= ticketCount %></td>
